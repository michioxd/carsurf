...
/// Let the app believe the car screen is the main screen. Off by default: it
/// fixes some apps and breaks others, so it is opt-in per app.
@property (nonatomic, readonly) BOOL spoofMainScreen;
